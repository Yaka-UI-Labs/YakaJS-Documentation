  ...
  return (
    <div className="relative max-w-full">
      ...
      <GridContainer className="2xl:before:hidden 2xl:after:hidden">
        <CategoryHeader className="text-fuchsia-500 dark:text-fuchsia-400">YakaJS in the wild</CategoryHeader>
      </GridContainer>
      ...
      <GridContainer>
        <p className="max-w-(--breakpoint-md) px-2 text-base/7 text-gray-600 max-sm:px-4 dark:text-gray-400">
          Because YakaJS is so flexible, it empowers you to build unique interactive experiences. From voice-controlled
          apps to reactive UIs, YakaJS gives you the tools without imposing the design.
        </p>
      </GridContainer>
