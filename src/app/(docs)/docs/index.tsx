export default {
  ...
  "DOM Manipulation": [
    ...
    ["Text Content", "/docs/text-content"],
    ["DOM Manipulation (Full)", "/docs/dom-manipulation"],
  ] as const,
  "Core Features": [
    ["Events & Event Handling", "/docs/events"],
    ["AJAX & HTTP Requests", "/docs/ajax"],
  ...
  "Advanced Features": [
    ...
    ["Routing & Navigation", "/docs/routing"],
    ["Voice Commands", "/docs/yakajs-voice-commands"],
