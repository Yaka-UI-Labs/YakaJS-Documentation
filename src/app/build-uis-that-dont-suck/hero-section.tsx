  ...
  return (
    <>
      <div aria-hidden="true" className="absolute inset-x-0 top-0 left-1/5 -z-10 aspect-video opacity-50">
        ...
        <div className="absolute inset-0 size-full bg-gradient-to-r from-gray-950 to-75%"></div>
        <div className="absolute inset-0 size-full bg-gradient-to-t from-gray-950 to-50%"></div>
      </div>
      <GridContainer>
