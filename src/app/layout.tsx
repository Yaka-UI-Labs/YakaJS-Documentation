...
export default async function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${outfit.variable} ${inter.variable} ${plexMono.variable} ${source.variable} ${ubuntuMono.variable} antialiased dark:bg-gray-950`}
      suppressHydrationWarning
    >
      <head>
        <link rel="icon" href="/yaka-icon-only.svg" type="image/svg+xml" />
        <link rel="alternate icon" href={v("/favicons/favicon.ico")} />
